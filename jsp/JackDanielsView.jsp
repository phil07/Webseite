...
<br> <br>
	<main class="main">
			<div class="content">
			<h2>Jack Daniel´s </h2> <br> <br>
			<ul class="produkte">
				<li>
					<div class="produkt">
						<img class="produkt-image" src="../IMG/Jack-Daniels-Old-No.-7-Tennessee-Whiskey.jpg" height="800px" width="auto" alt ="Alkohol"/>
					<div class="produkt-name">
					<a href="produkt.html">Jack Daniel´s 0,7L (40% Vol.) </a>
					</div>
